...
1. **[AI-Discovery]** Fix lỗi Function Calling và RAG để AI tìm đúng khóa học.
2. **[Học liệu - Scope & Language]** Chuẩn hóa dropdown chọn chương bài học và lọc động danh sách ngôn ngữ dưa trên transcript hiện có.
3. **[Học liệu - Quiz]** Xây dựng hệ thống làm bài Quiz, chấm điểm, lưu lịch sử, cho phép Giảng viên tạo ngân hàng câu hỏi.
